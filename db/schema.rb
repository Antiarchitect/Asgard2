...
ActiveRecord::Schema.define(:version => 20090515003325) do

  create_table "citology_tests", :force => true do |t|
    t.integer  "visit_id"
    t.float    "param1"
    t.float    "param2"
    t.float    "param3"
  ...
  create_table "endoscopic_tests", :force => true do |t|
    t.integer  "visit_id"
    t.float    "param1"
    t.float    "param2"
    t.float    "param3"
  ...
  create_table "laboratory_blood_analyses", :force => true do |t|
    t.integer  "visit_id"
    t.float    "param1"
    t.float    "param2"
    t.float    "param3"
